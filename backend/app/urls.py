...
urlpatterns = [
    ...
    path('api/events/', views.EventListCreateView.as_view(), name='event_list_create'),
    path('api/events/<int:event_id>/', views.EventDetailUpdateDeleteView.as_view(), name='event_detail_update_delete'),
